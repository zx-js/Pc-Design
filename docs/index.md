 ...
 * @LastEditors: bhabgs
 * @LastEditTime: 2019-11-21 11:28:22
 -->
<!-- # 组件使用指南 -->
...
> 该框架既定名称为 zx-util-ui less 存在层级关系，父级别定义的变量 通过`@import`能够 集成到子级别引用
>
> 1. 框架前缀名称要求
...
> 1.首先在 `./.vuepress/config/themeConfig.js` 文件配置好组件对应的 `sidebar` aa
